...
public class OTAPreferenceController extends AbstractPreferenceController
    ...
    private static final String KEY_DESCENDANT_UPDATES = "descendant_updates";
    Context mContext;
    ...
    public boolean isAvailable() {
        return Utils.isPackageInstalled(mContext, "org.descendant.ota");
    }

    @Override
    public String getPreferenceKey() {
        return KEY_DESCENDANT_UPDATES;
    }
}
